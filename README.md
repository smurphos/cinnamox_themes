...
Install via Cinnamon's Themes module in Cinnamon settings or download from [the releases page](https://github.com/smurphos/cinnamox_themes/releases) and unzip into your `~/.themes` directory.
